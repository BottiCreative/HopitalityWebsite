	...
	<div id="product-list-core-commerce-product-search-advanced-fields" class="product-list-search-advanced-fields" >
		...
		<div id="product-list-search-advanced-fields-inner">
			<div class="product-list-search-field">
				...
				<tr>
					...
					<?php  if ($options['search_mode'] == 'advanced') { ?>
						...
						<?php echo $form->label('price_from', t('Price From'))?>
						<?php echo $form->text('price_from', $search['price_from'], array('style' => 'width:140px')); ?>
						<?php echo $form->label('price_to', t('To'))?>
			...
			<div class="product-list-search-field">
				...
				<tr>
					<td style="white-space: nowrap" style="padding-right: 4px"><strong><?php echo t('Results Per Page')?></strong></td>
					<td>
