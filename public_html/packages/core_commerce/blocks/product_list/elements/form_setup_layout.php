...
<?php echo  $form->checkbox('options[show_products]',1, $options['show_products']) ?><?php echo  t('Show products (uncheck this to hide products and show only the search form)'); ?>
