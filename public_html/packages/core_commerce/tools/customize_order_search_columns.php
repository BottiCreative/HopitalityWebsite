...
if ($_POST['task'] == 'update_columns') {
	...
	$sc = AttributeKeyCategory::getByHandle('core_commerce_order');
...
$list = CoreCommerceOrderAttributeKey::getList();

?>

<form method="post" id="ccm-core-commerce-order-customize-search-columns-form" action="<?php echo $uh->getToolsURL('customize_order_search_columns')?>">
...
ccm_submitCustomizeSearchColumnsForm = function() {
	$("#ccm-core-commerce-order-customize-search-columns-form").ajaxSubmit(function(resp) {
...
$(function() {
	$('#ccm-core-commerce-order-customize-search-columns-form').submit(function() {
