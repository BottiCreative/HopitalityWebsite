var ccmAttributesHelper={   
	...
	editValue:function(val){ 
		if($('#akSelectValueDisplay_'+val).css('display')!='none'){
			...
			var txtAdjustmentValue =  $('#akSelectAdjustmentValueStatic_'+val).html();
			$('#akSelectAdjustmentValueField_'+val).val( $('<div/>').html(txtAdjustmentValue).text());
		}
	},
	...
	changeValue:function(val){ 
		...
		var txtAdjustmentValue = $('<div/>').text($('#akSelectAdjustmentValueField_'+val).val()).html();
		$('#akSelectAdjustmentValueStatic_'+val).html( txtAdjustmentValue );
		this.editValue(val);
	},
