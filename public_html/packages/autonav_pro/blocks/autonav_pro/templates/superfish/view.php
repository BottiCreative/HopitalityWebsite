...
echo '<div class="anp_superfish anp_superfish' . $bID . '"  id="anp_superfish' . $bID . '">';
echo '<ul class="pronav_list pronav_list'. $bID . ' superfish-menu'.$bID.' " id="pronav_list'. $bID . '">';
...
.anp_superfish #pronav_list'. $bID . ' > li > .dropdown-menu:after,
 .lexus_efx .anp_superfish #pronav_list'. $bID . ' > li > .dropdown-menu:before,
 #pronav_list'. $bID . ' ul.dropdown-menu,
 .lexus_efx #pronav_list'. $bID . ' ul.dropdown-menu,
 div#main-container #header ul#pronav_list'. $bID . ' ul.dropdown-menu,
 #pronav_list'. $bID . ' li,
 div#main-container ul#pronav_list'. $bID . ' ul.dropdown-menu{
...
#pronav_list'. $bID . ' .dropdown-menu a,
 ...
 .anp_superfish #pronav_list'. $bID . ' .dropdown-menu a{
	padding: 10px 15px;
	color:#999999;
	position:relative
}
...
.anp_superfish #pronav_list'. $bID . ' .caret ,
 ...
 .anp_superfish #pronav_list'. $bID . ' .dropdown-menu .nav-selected > a,
 .anp_superfish #pronav_list'. $bID . ' .dropdown-menu  li.open > a,
 .anp_superfish #pronav_list'. $bID . ' .dropdown-menu .nav-selected > a:hover,
 .anp_superfish #pronav_list'. $bID . ' .dropdown-menu  li > a:focus,
 .anp_superfish #pronav_list'. $bID . ' .dropdown-menu  li > a:hover,
 .anp_superfish #pronav_list'. $bID . ' .dropdown-menu  li > a:focus
 {
	color: #ffffff;
...
if ($customnav == 1) {
	//custom top bg color
	if ($bgcolor_c == 1) {
		echo '#anp_superfish' . $bID . '{background-color:' . $bgcolor .'!important;background-image:none!important;box-shadow:none!important}';
		
	}
	//custom sublvl bg color
	if ($sbgcolor_c == 1) {
		echo '#pronav_list' . $bID . ' ul,#pronav_list' . $bID . ' ul:after{border:none;box-shadow:none;background-color:' . $sbgcolor . '!important}';
	...
	if ($fontcolor_c == 1) {
		...
		echo '#anp_superfish' . $bID . ' .pronav_btn_navbar .pronav_icon_bar{background-color:' . $fontcolor .'!important;background-image:none!important}';
	}
	...
	if ($bgtabcolor_c == 1) {
		...
		echo '#anp_superfish' . $bID . ' .pronav_btn_navbar {background-color:' . $bgtabcolor .'!important;background-image:none!important}';
	...
	if ($sfontcolor_c == 1) {
		echo '#pronav_list' . $bID . ' ul.sublvl a ,#pronav_list' . $bID . ', #pronav_list' . $bID . ' ul.sublvl a:visited {color:' . $sfontcolor . '!important}';
		
		echo '.anp_superfish #pronav_list' . $bID . ' ul.sublvl a .caret, #pronav_list' . $bID . ' .open  ul.sublvl a .caret,#pronav_list' . $bID . ' ul.sublvl a .caret{ border-left-color:' . $sfontcolor . ';border-top-color:transparent;}';
		if($responsive!=0 && $responsive!='0'){
		echo ' @media(max-width:'.$responsive.'px){.anp_superfish #pronav_list' . $bID . ' ul.sublvl a .caret, #pronav_list' . $bID . ' .open  ul.sublvl a .caret,#pronav_list' . $bID . ' ul.sublvl a .caret{border-left-color:transparent;border-top-color:' . $sfontcolor . '}}';
		}
	}
	//custom font color for sublvl links,on hover state
	if ($sfontcolorh_c == 1) {
		echo '#pronav_list' . $bID . ' ul.sublvl a:hover,#pronav_list' . $bID . ' ul.sublvl .nav-selected > a,#pronav_list' . $bID . ' ul.sublvl .nav-selected > a:visited {color:' . $sfontcolorh . '!important}';
	...
	if ($sfontstyle_c == 1) {
		switch ($sfontstyle) {
			case 'normal' :
				echo '#pronav_list' . $bID . ' ul.sublvl a ,#pronav_list' . $bID . ' ul.sublvl {font-style:normal!important;font-weight:normal!important}';
				break;
			case 'italic' :
				echo '#pronav_list' . $bID . ' ul.sublvl a ,#pronav_list' . $bID . ' ul.sublvl {font-style:italic!important;font-weight:normal!important}';
				break;
			case 'oblique' :
				echo '#pronav_list' . $bID . ' ul.sublvl a ,#pronav_list' . $bID . ' ul.sublvl {font-style:oblique!important;font-weight:normal!important}';
				break;
			case 'bold' :
				echo '#pronav_list' . $bID . ' ul.sublvl a ,#pronav_list' . $bID . ' ul.sublvl{font-style:normal!important;font-weight:bold!important}';
				break;
			case 'italic_b' :
				echo '#pronav_list' . $bID . ' ul.sublvl a ,#pronav_list' . $bID . ' ul.sublvl{font-style:italic!important;font-weight:bold!important}';
				break;
			case 'oblique_b' :
				echo '#pronav_list' . $bID . ' ul.sublvl a ,#pronav_list' . $bID . ' ul.sublvl{font-style:oblique!important;font-weight:bold!important}';
				break;
			default :
				echo '#pronav_list' . $bID . ' ul.sublvl a ,#pronav_list' . $bID . ' ul.sublvl{font-style:normal!important;font-weight:normal!important}';
		}
	...
	if ($sbgtabcolor_c == 1) {
		echo '#pronav_list' . $bID . ' ul.sublvl a, #pronav_list' . $bID . ' ul.sublvl a:visited {background-color:' . $sbgtabcolor . '!important;background-image:none!important} ';
	}

	//custom sublvl tab bg color,hover state
	if ($sbgtabcolorh_c == 1) {
		echo '#pronav_list' . $bID . ' .nav-selected > ul.sublvl a,#pronav_list' . $bID . ' .nav-selected > ul.sublvl a:visited, #pronav_list' . $bID . ' .pronav_list-path-selected > ul.sublvl a, #pronav_list' . $bID . ' .nav-selected > ul.sublvl a:hover, #pronav_list' . $bID . ' > li > ul.sublvl a:hover ,#pronav_list' . $bID . '  > ul.sublvl .nav-selected a {background-color:' . $sbgtabcolorh . '!important;background-image:none!important} ';
	}	
}
echo '</style>';
