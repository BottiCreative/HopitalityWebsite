...
echo '<ol class="nav nav-pills nav-stacked anp-stacked pronav_list'. $bID . ' anp-stacked-right" id="pronav_list'. $bID . '">';
...
if ($ni['hasSubmenu']|| $ni['anp_sublvl_stack'] == 1 || $ni['anp_sublvl_content'] !=null){
	if(!$ni['anp_hide_children']){
		...
		$htlm_csublvl='<span class="badge pull-left">'.$count_sublvl.'</span>';
	}
}
