...
echo '<ol class="pronav_list pronav_list_dark pronav_list'. $bID . '" id="pronav_list'. $bID . '">';
...
//add sublvl stack 		
		...
		echo '<ol class="sublvl dropdown-menu dropdown-stack"><li>';
...
.pronav_collapse #pronav_list'. $bID . ' > li {
	float: none;
}
#pronav_list'. $bID . ' > li > a {
	display:block
}
.pro_navbar' . $bID . ' #pronav_list'. $bID . ' > li > .dropdown-menu:after, .lexus_efx .pro_navbar #pronav_list'. $bID . ' > li > .dropdown-menu:before,.pro_navbar' . $bID . ' ol.dropdown-menu, .lexus_efx ol.dropdown-menu, div#main-container #header ol#pronav_list'. $bID . ' ol.dropdown-menu,#pronav_list'. $bID . ' li,div#main-container ol#pronav_list'. $bID . ' ol.dropdown-menu{
...
.pro_navbar #pronav_list'. $bID . ' > li > .dropdown-menu:after, .lexus_efx .pro_navbar #pronav_list'. $bID . ' > li > .dropdown-menu:before{
	display:block
}
#pronav_list'. $bID . ' .dropdown-menu,#pronav_list'. $bID . ' .dropdown-menu:before,#pronav_list'. $bID . ' .dropdown-menu:after{
...
.pronav_collapse #pronav_list'. $bID . ' .sublvl{
	width:auto!important
}
.pro_navbar' . $bID . ' .dropdown-menu a,.pro_navbar' . $bID . ' .dropdown-menu a:visited, .pro_navbar #pronav_list'. $bID . ' .dropdown-menu a{
	padding: 10px 15px;
	color:#999999;
	position:relative
}
.pro_navbar' . $bID . ' .dropdown-menu .caret,#pronav_list'. $bID . ' .open .dropdown-menu .caret{
	border-color: #fff transparent transparent transparent;
}
.pro_navbar #pronav_list'. $bID . ' .caret ,#pronav_list'. $bID . ' .open  .caret{
	border-color: #fff transparent transparent transparent ;
}
...
.pro_navbar #pronav_list'. $bID . ' .dropdown-menu  li > a:focus{
	color: #ffffff;
...
.pro_navbar #pronav_list'. $bID . ' > li.search_container {
	float: none;
	text-align: center;
}
...
if ($customnav == 1) {
	...
	if ($fontcolor_c == 1) {
		echo '.pro_navbar #pronav_list' . $bID . ' .caret, #pronav_list' . $bID . ' .open .caret,.pro_navbar #pronav_list' . $bID . ' .caret, #pronav_list' . $bID . ' .open .caret,#pronav_list' . $bID . ' .caret{ border-top-color:' . $fontcolor . ';} #pronav_list' . $bID . ' .dropdown-menu .caret{border-left-color:' . $fontcolor . ';border-top-color:transparent}';
		if($responsive!=0 && $responsive!='0'){
		echo ' @media(max-width:'.$responsive.'px){.pro_navbar #pronav_list' . $bID . ' .caret, #pronav_list' . $bID . ' .open .caret,#pronav_list' . $bID . ' .dropdown-menu .caret{border-left-color:transparent;border-top-color:' . $fontcolor . '}}';
		}
	...
	if ($sfontcolor_c == 1) {
		...
		echo '.pro_navbar #pronav_list' . $bID . ' ol.sublvl a .caret, #pronav_list' . $bID . ' .open  ol.sublvl a .caret,#pronav_list' . $bID . ' ol.sublvl a .caret{ border-left-color:' . $sfontcolor . ';border-top-color:transparent;}';
		if($responsive!=0 && $responsive!='0'){
		echo ' @media(max-width:'.$responsive.'px){.pro_navbar #pronav_list' . $bID . ' ol.sublvl a .caret, #pronav_list' . $bID . ' .open  ol.sublvl a .caret,#pronav_list' . $bID . ' ol.sublvl a .caret{border-left-color:transparent;border-top-color:' . $sfontcolor . '}}';
		}
	...
	if ($sbgtabcolorh_c == 1) {
		echo '#pronav_list' . $bID . ' .nav-selected > ol.sublvl a, #pronav_list' . $bID . ' .pronav_list-path-selected > ol.sublvl a, #pronav_list' . $bID . ' .nav-selected > ol.sublvl a:hover, #pronav_list' . $bID . ' > li > ol.sublvl a:hover,#pronav_list' . $bID . '  > ol.sublvl .nav-selected a {background-color:' . $sbgtabcolorh . '!important;background-image:none!important} ';
		echo '.pro_navbar' . $bID . ' .dropdown-menu .nav-selected > a,
			.pro_navbar' . $bID . ' .dropdown-menu  li.open > a,
			.pro_navbar' . $bID . ' .dropdown-menu .nav-selected > a:hover,
			.pro_navbar #pronav_list'. $bID . ' .dropdown-menu .nav-selected > a,
			.pro_navbar #pronav_list'. $bID . ' .dropdown-menu  li.open > a,
			.pro_navbar #pronav_list'. $bID . ' .dropdown-menu .nav-selected > a:hover,
			.pro_navbar #pronav_list'. $bID . ' .dropdown-menu  li > a:focus{background-color:' . $sbgtabcolorh . '!important;background-image:none!important}';
