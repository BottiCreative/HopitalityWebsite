...
TINY.table=function(){
	...
	sorter.prototype.init=function(){
		...
		for(i;i<t.w;i++){
			...
			if(d){
				var o=document.createElement('option');	o.value=i; var oo = T$$('strong',c); if(oo.length > 0) { o.innerHTML=oo[0].innerHTML; d.appendChild(o) }
			}
		}
		this.reset()
	};
	...
	if(this.p.pageddid){T$(this.p.pageddid).value=this.g}
