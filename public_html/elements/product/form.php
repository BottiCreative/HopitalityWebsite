...
if (is_object($product)) { 
   ...
   $prQuantityAllowNegative = $product->getProductNegativeQuantitySetting();
	...
	//defaults for add product
	$prQuantityAllowNegative = (string)CoreCommerceProduct::NEGATIVE_QUANTITY_SYSTEM;
      ...
      <div class="clearfix">
         ...
         <div class="input">
            <?php echo $form->select('prQuantityAllowNegative', array(
                  (string)CoreCommerceProduct::NEGATIVE_QUANTITY_YES => t('Yes'),
                  (string)CoreCommerceProduct::NEGATIVE_QUANTITY_NO => t('No'),
                  (string)CoreCommerceProduct::NEGATIVE_QUANTITY_SYSTEM => t('System default')
