...
class TestimonialReviewBlockController extends BlockController {
	
	protected $btName = 'Testimonial';
	protected $btDescription = '';
	protected $btTable = 'btDCTestimonialReview';
	...
	public function view() {
		$this->set('field_6_image', (empty($this->field_6_image_fID) ? null : $this->get_image_object($this->field_6_image_fID, 150, 150, true)));
	}
	...
	public function save($args) {
		...
		$args['field_6_image_internalLinkCID'] = empty($args['field_6_image_internalLinkCID']) ? 0 : $args['field_6_image_internalLinkCID'];
		parent::save($args);
	}
