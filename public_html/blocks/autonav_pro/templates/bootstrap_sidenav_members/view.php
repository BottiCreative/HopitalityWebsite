...
/*
 ...
 $navitems[<element number>]['count_children'] => count children under this element;
 $navitems[<element number>]['anp_exclude_nav'] => exclude element from autonav pro;
 $navitems[<element number>]['anp_hide_children'] => hide children under this element;
...
echo '<ol class="nav nav-pills nav-stacked anp-stacked pronav_list'. $bID . ' anp-stacked-left" id="pronav_list'. $bID . '">';
...
if ($ni['hasSubmenu']|| $ni['anp_sublvl_stack'] == 1 || $ni['anp_sublvl_content'] !=null){
	if(!$ni['anp_hide_children']){
		$count_sublvl=$ni['count_children'];
		$htlm_csublvl='<span class="badge pull-right">'.$count_sublvl.'</span>';
	}
}
...
if ($ni['hasSubmenu']|| $ni['anp_sublvl_stack'] == 1 || $ni['anp_sublvl_content'] !=null){$ni['url']='javascript:void(0)';$ni['anp_overwrite_link']=''; $ni['classes'].=' drop_a_custompro';}
		...
		echo '</span>';
		if ($ni['hasSubmenu']|| $ni['anp_sublvl_stack'] == 1 || $ni['anp_sublvl_content'] !=null){echo $htlm_csublvl;}
		echo '</a>';
