...
class TestimonialMainBlockController extends BlockController {
	
	protected $btName = 'Testimonial';
	protected $btDescription = '';
	protected $btTable = 'btDCTestimonialMain';
	...
	public function view() {
		$this->set('field_2_image', (empty($this->field_2_image_fID) ? null : $this->get_image_object($this->field_2_image_fID, 70, 70, true)));
	}
